...
void DividerUnsigned_CVA6::updateDelay(void){
   
  int delay = 0;

  uint64_t op_a = rs1_data_ptr[getInstrIdx()];
  uint64_t op_b = rs2_data_ptr[getInstrIdx()];
...
int DividerUnsigned_CVA6::findLeadingZeroCnt(uint64_t op_)
{

...
#ifndef MAP_MODEL_DIVIDER_CVA6_H
#define MAP_MODEL_DIVIDER_CVA6_H
...
class Divider_CVA6 : public ResourceModel{

public:
  Divider_CVA6() {};
  ~Divider_CVA6() = default;
...
#endif // MAP_MODEL_DIVIDER_CVA6_H

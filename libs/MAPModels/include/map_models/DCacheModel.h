...
#ifndef MAP_MODEL_D_CACHE_MODEL_H
#define MAP_MODEL_D_CACHE_MODEL_H
...
public:
    DCacheModel(const DCacheModel_Config& cfg_):
...
private:
    ...
    mutable std::vector<DCacheEntry> cache;
...
#endif // MAP_MODEL_D_CACHE_MODEL_H
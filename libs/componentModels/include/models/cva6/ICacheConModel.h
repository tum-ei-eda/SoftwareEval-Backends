...
#ifndef I_CACHE_CON_MODEL_H
#define I_CACHE_CON_MODEL_H
...
struct ICacheConEntry
{
  uint64_t tag = 0;
  bool valid = false;
};

class ICacheConModel : public ResourceModel
{
public:

  ICacheConModel(PerformanceModel* parent_) : ResourceModel("ICacheConModel", parent_), CACHE_DELAY(1), MEMORY_DELAY(5) {};
...
private:
  ...
  ICacheConEntry tag_cache[4][256];

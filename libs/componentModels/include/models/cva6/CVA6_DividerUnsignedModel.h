...
class CVA6_DividerUnsignedModel : public ResourceModel
{
public:
  CVA6_DividerUnsignedModel(PerformanceModel* parent_) : ResourceModel("CVA6_DividerUnsignedModel", parent_) {};

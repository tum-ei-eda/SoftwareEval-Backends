...
int ICacheConModel::getDelay(void)
{
...
bool ICacheConModel::inCache(uint64_t pc_)
{
...
void ICacheConModel::updateCache(uint64_t tag_, uint64_t index_)
{
    int way = -1;

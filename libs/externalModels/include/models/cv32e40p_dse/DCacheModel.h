...
#ifndef CV32E40P_DSE_D_CACHE_MODEL_H
#define CV32E40P_DSE_D_CACHE_MODEL_H
...
public:
    ...
    DCacheModel(PerformanceModel* parent_):     
        ResourceModel("DCacheModel", parent_), 
        CACHE_DELAY(1), 
        MEMORY_DELAY(5), 
        NUM_WAYS(4),
...
#endif // CV32E40P_DSE_D_CACHE_MODEL_H
...
void Vicuna_zvl512b_PerformanceModel::connectChannel(Channel* channel_)
{
  Vicuna_zvl512b_Channel* channel = static_cast<Vicuna_zvl512b_Channel*>(channel_);
...
uint64_t Vicuna_zvl512b_PerformanceModel::getCycleCount(void)
{
...
std::string Vicuna_zvl512b_PerformanceModel::getPipelineStream(void)
{
...
std::string Vicuna_zvl512b_PerformanceModel::getPrintHeader(void)
{
  std::stringstream ret_strs;

...
#ifndef SWEVAL_BACKENDS_VICUNA_ZVL512B_PERFORMANCE_MODEL_H
#define SWEVAL_BACKENDS_VICUNA_ZVL512B_PERFORMANCE_MODEL_H
...
namespace Vicuna_zvl512b{

extern SchedulingFunctionSet* Vicuna_zvl512b_SchedulingFunctionSet;

class Vicuna_zvl512b_PerformanceModel : public PerformanceModel
{
public:

  Vicuna_zvl512b_PerformanceModel() : PerformanceModel("Vicuna_zvl512b", Vicuna_zvl512b_SchedulingFunctionSet)
    ,V_IQ_stg(2,0)
...
#endif // SWEVAL_BACKENDS_VICUNA_ZVL512B_PERFORMANCE_MODEL_H
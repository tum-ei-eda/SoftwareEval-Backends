...
#ifndef SWEVAL_BACKENDS_VICUNA_ZVL512B_PRINTER_H
#define SWEVAL_BACKENDS_VICUNA_ZVL512B_PRINTER_H
...
class Vicuna_zvl512b_Printer : public Printer
{
public:

  Vicuna_zvl512b_Printer();
...
#endif // SWEVAL_BACKENDS_VICUNA_ZVL512B_PRINTER_H
...
SchedulingFunctionSet* TestCore_SchedulingFunctionSet = new SchedulingFunctionSet("TestCore_SchedulingFunctionSet");

static SchedulingFunction *schedulingFunction__def = new SchedulingFunction(
  TestCore_SchedulingFunctionSet,
  "_def",
  0,
  [](PerformanceModel* perfModel_){
  TestCore_PerformanceModel* perfModel = static_cast<TestCore_PerformanceModel*>(perfModel_);
  // Enter

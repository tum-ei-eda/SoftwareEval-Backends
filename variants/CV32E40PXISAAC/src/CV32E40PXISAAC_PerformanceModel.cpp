...
void CV32E40PXISAAC_PerformanceModel::connectChannel(Channel* channel_)
{
  CV32E40PXISAAC_Channel* channel = static_cast<CV32E40PXISAAC_Channel*>(channel_);
...
uint64_t CV32E40PXISAAC_PerformanceModel::getCycleCount(void)
{
...
std::string CV32E40PXISAAC_PerformanceModel::getPipelineStream(void)
{
...
std::string CV32E40PXISAAC_PerformanceModel::getPrintHeader(void)
{
  std::stringstream ret_strs;

...
extern InstructionPrinterSet* CV32E40PXISAAC_InstrPrinterSet;

CV32E40PXISAAC_Printer::CV32E40PXISAAC_Printer(): Printer("CV32E40PXISAAC_Printer", CV32E40PXISAAC_InstrPrinterSet)
{}

void CV32E40PXISAAC_Printer::connectChannel(Channel* ch_)
{
  CV32E40PXISAAC_Channel* channel = static_cast<CV32E40PXISAAC_Channel*>(ch_);
...
std::string CV32E40PXISAAC_Printer::getPrintHeader(void)
{

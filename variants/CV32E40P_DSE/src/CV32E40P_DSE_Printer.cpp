...
extern InstructionPrinterSet* CV32E40P_DSE_InstrPrinterSet;

CV32E40P_DSE_Printer::CV32E40P_DSE_Printer(): Printer("CV32E40P_DSE_Printer", CV32E40P_DSE_InstrPrinterSet)
{}

void CV32E40P_DSE_Printer::connectChannel(Channel* ch_)
{
  CV32E40P_DSE_Channel* channel = static_cast<CV32E40P_DSE_Channel*>(ch_);
...
std::string CV32E40P_DSE_Printer::getPrintHeader(void)
{

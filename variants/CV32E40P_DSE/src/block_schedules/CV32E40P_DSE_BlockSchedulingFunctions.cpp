...
const std::array<const MAP_Explorer::Block*, 733> CV32E40P_DSE_blocks{{
    &block_304,
    &block_307,
    &block_308,
    &block_305,
...
extern const MAP_Explorer::BlockDictionary CV32E40P_DSE_blockDict{CV32E40P_DSE_blocks.data(), CV32E40P_DSE_blocks.size(), 86};

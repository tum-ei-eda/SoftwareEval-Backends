...
static void block_747_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_747{
    747,
    464,
    472,
    block_747_fn
...
static void block_750_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_750{
    750,
    53692,
    53708,
    block_750_fn
...
static void block_751_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_751{
    751,
    49660,
    49668,
    block_751_fn
...
static void block_771_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_771{
    771,
    22876,
    22884,
    block_771_fn
...
static void block_775_fn(uint64_t* vec_, uint8_t* d_){
    	uint64_t t_0 = MAP_Explorer::max2(+d_[2], +2);
...
extern const MAP_Explorer::Block block_775{
    775,
    51912,
    51920,
    block_775_fn
...
static void block_778_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_778{
    778,
    78880,
    78892,
    block_778_fn
...
static void block_787_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_787{
    787,
    79308,
    79308,
    block_787_fn
...
static void block_790_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_790{
    790,
    78896,
    78904,
    block_790_fn
...
static void block_792_fn(uint64_t* vec_, uint8_t* d_){
    	uint64_t t_0 = MAP_Explorer::max2(+d_[3], +d_[2]);
	uint64_t t_1 = MAP_Explorer::max2(+d_[3]+d_[5], +1+t_0);
	uint64_t t_2 = MAP_Explorer::max2(+d_[5], +d_[2]);
...
extern const MAP_Explorer::Block block_792{
    792,
    54152,
    54176,
    block_792_fn
...
static void block_794_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_794{
    794,
    54636,
    54644,
    block_794_fn

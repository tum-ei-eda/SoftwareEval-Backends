...
static void block_213_fn(uint64_t* vec_, uint8_t* d_){
	...
	uint64_t out_0 = MAP_Explorer::max2(out_37 -1+d_[3], vec_[25] +1);
...
static void block_226_fn(uint64_t* vec_, uint8_t* d_){
	...
	uint64_t out_38 = MAP_Explorer::max2(out_37 +1+d_[2], vec_[23] +1);
	uint64_t out_2 = out_38;
	uint64_t out_1 = out_38 -1;
...
static void block_228_fn(uint64_t* vec_, uint8_t* d_){
	...
	uint64_t out_0 = MAP_Explorer::max2(vec_[0] +d_[0]+d_[1]+t_2, vec_[1] +d_[1]+t_2);
	out_0 = MAP_Explorer::max2(out_0, vec_[2] +t_2);
	out_0 = MAP_Explorer::max2(out_0, vec_[3] +t_3);
	out_0 = MAP_Explorer::max2(out_0, vec_[6] +t_2);
	out_0 = MAP_Explorer::max2(out_0, vec_[36] +d_[0]+d_[1]+t_2);

...
static void block_1107_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_1107{
    1107,
    48472,
    48496,
    block_1107_fn
...
static void block_1108_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_1108{
    1108,
    49384,
    49460,
    block_1108_fn
...
static void block_1125_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_1125{
    1125,
    21656,
    21664,
    block_1125_fn
...
static void block_1126_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_1126{
    1126,
    51132,
    51140,
    block_1126_fn
...
static void block_1127_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_1127{
    1127,
    21668,
    21688,
    block_1127_fn
...
static void block_1129_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_1129{
    1129,
    50568,
    50576,
    block_1129_fn
...
static void block_1132_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_1132{
    1132,
    76708,
    76720,
    block_1132_fn
...
static void block_1141_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_1141{
    1141,
    77136,
    77136,
    block_1141_fn
...
static void block_1144_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_1144{
    1144,
    76724,
    76732,
    block_1144_fn
...
static void block_1145_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_1145{
    1145,
    51976,
    51976,
    block_1145_fn
...
static void block_1146_fn(uint64_t* vec_, uint8_t* d_){
    	uint64_t t_0 = MAP_Explorer::max2(+d_[3], +d_[2]);
	uint64_t t_1 = MAP_Explorer::max2(+d_[3]+d_[5], +1+t_0);
	uint64_t t_2 = MAP_Explorer::max2(+d_[5], +d_[2]);
...
extern const MAP_Explorer::Block block_1146{
    1146,
    51980,
    52004,
    block_1146_fn
...
static void block_1147_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_1147{
    1147,
    52008,
    52044,
    block_1147_fn
...
static void block_1148_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_1148{
    1148,
    52464,
    52472,
    block_1148_fn
...
static void block_1149_fn(uint64_t* vec_, uint8_t* d_){
    	uint64_t t_0 = MAP_Explorer::max2(+d_[3], +d_[2]);
	uint64_t t_1 = MAP_Explorer::max2(+d_[3]+d_[5], +1+t_0);
	uint64_t t_2 = MAP_Explorer::max2(+d_[5], +d_[2]);
	uint64_t t_3 = MAP_Explorer::max2(+d_[3]+d_[5]+d_[6], +1+t_1);
...
extern const MAP_Explorer::Block block_1149{
    1149,
    52504,
    52524,
    block_1149_fn
...
static void block_1150_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_1150{
    1150,
    52196,
    52216,
    block_1150_fn
...
static void block_1151_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_1151{
    1151,
    76736,
    76736,
    block_1151_fn
...
static void block_1152_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_1152{
    1152,
    49508,
    49512,
    block_1152_fn
...
static void block_1153_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_1153{
    1153,
    49516,
    49560,
    block_1153_fn
...
static void block_1154_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_1154{
    1154,
    48456,
    48460,
    block_1154_fn
...
static void block_1155_fn(uint64_t* vec_, uint8_t* d_){
...
extern const MAP_Explorer::Block block_1155{
    1155,
    104804,
    104808,
    block_1155_fn

...
static void block_1271_fn(uint64_t* vec_, uint8_t* d_){
	...
	out_22 = MAP_Explorer::max2(out_22, vec_[14] +3+d_[2]);
	...
	out_23 = MAP_Explorer::max2(out_23, vec_[14] +3+d_[2]+d_[3]);
	out_23 = MAP_Explorer::max2(out_23, vec_[36] +3+d_[0]+d_[1]+d_[2]+d_[3]);
	uint64_t out_4 = out_23 -1+d_[4]+d_[5]+d_[6];
	uint64_t out_24 = out_23 +d_[4];
	uint64_t out_25 = out_23 +d_[4]+d_[5];
	uint64_t out_37 = out_23 -2+d_[4]+d_[5];
	uint64_t out_38 = out_23 -2+d_[4]+d_[5]+d_[6];

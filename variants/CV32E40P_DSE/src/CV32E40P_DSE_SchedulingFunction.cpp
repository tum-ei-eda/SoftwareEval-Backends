...
SchedulingFunctionSet* CV32E40P_DSE_SchedulingFunctionSet = new SchedulingFunctionSet("CV32E40P_DSE_SchedulingFunctionSet");

static SchedulingFunction *schedulingFunction_add = new SchedulingFunction(
  CV32E40P_DSE_SchedulingFunctionSet,
  "add",
  0,
  [](PerformanceModel* perfModel_){
  CV32E40P_DSE_PerformanceModel* perfModel = static_cast<CV32E40P_DSE_PerformanceModel*>(perfModel_);
  // Enter
...
n_IPort_R = n_IPort_R_max + perfModel->iCache.getDelay();
// PCGen
uint64_t n_PCGen;
...
// DPort_W
uint64_t n_DPort_W;
n_DPort_W = n_EX_stage + perfModel->dCache.getDelay();
// WB_stage

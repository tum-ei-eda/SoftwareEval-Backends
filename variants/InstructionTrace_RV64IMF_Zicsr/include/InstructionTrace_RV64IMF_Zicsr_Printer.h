...
#ifndef SWEVAL_BACKENDS_INSTRUCTIONTRACE_RV64IMF_ZICSR_PRINTER_H
#define SWEVAL_BACKENDS_INSTRUCTIONTRACE_RV64IMF_ZICSR_PRINTER_H
...
class InstructionTrace_RV64IMF_Zicsr_Printer : public Printer
{
public:

  InstructionTrace_RV64IMF_Zicsr_Printer();
  ...
  int get_rs3_data(void){ return rs3_data_ptr[instrIndex]; };
...
#endif // SWEVAL_BACKENDS_INSTRUCTIONTRACE_RV64IMF_ZICSR_PRINTER_H
...
InstructionPrinterSet *InstructionTrace_RV64IMF_Zicsr_InstrPrinterSet = new InstructionPrinterSet("InstructionTrace_RV64IMF_Zicsr_InstrPrinterSet");

static InstructionPrinter *instrPrinter_Reg_Reg_Type = new InstructionPrinter(
  InstructionTrace_RV64IMF_Zicsr_InstrPrinterSet,
  "Reg_Reg_Type",
  0,
  [](Printer* printer_){
    std::stringstream ret_strs;
    InstructionTrace_RV64IMF_Zicsr_Printer* printer = static_cast<InstructionTrace_RV64IMF_Zicsr_Printer*>(printer_);
    ...
    ret_strs << std::setfill(' ') << std::setw(75) << std::left << printer->get_assembly() << " , ";
...
static InstructionPrinter *instrPrinter_F_Reg_Reg_Type = new InstructionPrinter(
  InstructionTrace_RV64IMF_Zicsr_InstrPrinterSet,
  "F_Reg_Reg_Type",
  2,
  [](Printer* printer_){
...
static InstructionPrinter *instrPrinter_F_Reg_Type = new InstructionPrinter(
  InstructionTrace_RV64IMF_Zicsr_InstrPrinterSet,
  "F_Reg_Type",
  3,
  [](Printer* printer_){
...
static InstructionPrinter *instrPrinter_F_Reg_Reg_Reg_Type = new InstructionPrinter(
  InstructionTrace_RV64IMF_Zicsr_InstrPrinterSet,
  "F_Reg_Reg_Reg_Type",
  4,
  [](Printer* printer_){
    ...
    ret_strs << "0x" << std::setfill('0') << std::setw(16) << std::right << std::hex << printer->get_rs1_data() << " , ";
    ret_strs << "0x" << std::setfill('0') << std::setw(16) << std::right << std::hex << printer->get_rs2_data() << " , ";
    ret_strs << "0x" << std::setfill('0') << std::setw(16) << std::right << std::hex << printer->get_rs3_data() << " , ";
    ret_strs << "0x" << std::setfill('0') << std::setw(16) << std::right << std::hex << printer->get_rd_data() << " , ";
    ret_strs << std::setfill('-') << std::setw(18) << "" << " , ";
    ret_strs << std::setfill('-') << std::setw(18) << "" << " , ";
    ret_strs << std::setfill('-') << std::setw(18) << "" << " , ";
...
static InstructionPrinter *instrPrinter_F_Load_Type = new InstructionPrinter(
  InstructionTrace_RV64IMF_Zicsr_InstrPrinterSet,
  "F_Load_Type",
  6,
  [](Printer* printer_){
...
static InstructionPrinter *instrPrinter_F_Store_Type = new InstructionPrinter(
  InstructionTrace_RV64IMF_Zicsr_InstrPrinterSet,
  "F_Store_Type",
  8,
  [](Printer* printer_){
...
static InstructionPrinter *instrPrinter_F_F2X_Type = new InstructionPrinter(
  InstructionTrace_RV64IMF_Zicsr_InstrPrinterSet,
  "F_F2X_Type",
  13,
  [](Printer* printer_){
...
static InstructionPrinter *instrPrinter_F_X2F_Type = new InstructionPrinter(
  InstructionTrace_RV64IMF_Zicsr_InstrPrinterSet,
  "F_X2F_Type",
  14,
  [](Printer* printer_){

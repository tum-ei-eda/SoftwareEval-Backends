...
#ifndef SWEVAL_BACKENDS_VICUNA_PRINTER_H
#define SWEVAL_BACKENDS_VICUNA_PRINTER_H
...
class Vicuna_Printer : public Printer
{
public:
  ...
  uint64_t get_isWidening(void){ return isWidening_ptr[instrIndex]; };
...
#endif // SWEVAL_BACKENDS_VICUNA_PRINTER_H
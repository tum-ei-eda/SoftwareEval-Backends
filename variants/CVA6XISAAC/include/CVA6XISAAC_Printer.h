...
#ifndef SWEVAL_BACKENDS_CVA6XISAAC_PRINTER_H
#define SWEVAL_BACKENDS_CVA6XISAAC_PRINTER_H
...
class CVA6XISAAC_Printer : public Printer
{
public:
...
#endif // SWEVAL_BACKENDS_CVA6XISAAC_PRINTER_H
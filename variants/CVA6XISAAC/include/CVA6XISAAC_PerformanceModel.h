...
#ifndef SWEVAL_BACKENDS_CVA6XISAAC_PERFORMANCE_MODEL_H
#define SWEVAL_BACKENDS_CVA6XISAAC_PERFORMANCE_MODEL_H
...
extern SchedulingFunctionSet* CVA6XISAAC_SchedulingFunctionSet;

class CVA6XISAAC_PerformanceModel : public PerformanceModel
{
public:

  CVA6XISAAC_PerformanceModel() : PerformanceModel("CVA6XISAAC", CVA6XISAAC_SchedulingFunctionSet)
    ,IF_stage(3,0)
    ,IQ_stage(7,0)
    ,EX_stage(8,0)
    ,COM_stage(2,0)
  ...
  uint64_t EX_substage_CUSTOM0 = 0;
...
#endif // SWEVAL_BACKENDS_CVA6XISAAC_PERFORMANCE_MODEL_H
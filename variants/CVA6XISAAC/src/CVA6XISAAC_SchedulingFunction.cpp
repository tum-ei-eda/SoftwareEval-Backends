...
namespace CVA6XISAAC{

SchedulingFunctionSet* CVA6XISAAC_SchedulingFunctionSet = new SchedulingFunctionSet("CVA6XISAAC_SchedulingFunctionSet");

static SchedulingFunction *schedulingFunction__def = new SchedulingFunction(
  CVA6XISAAC_SchedulingFunctionSet,
  "_def",
  0,
  [](PerformanceModel* perfModel_){
  CVA6XISAAC_PerformanceModel* perfModel = static_cast<CVA6XISAAC_PerformanceModel*>(perfModel_);
  // Enter
...
// IS_stage
uint64_t n_IS_stage;
n_IS_stage = std::max({n_Issue, n_uA_Clobber, n_uA_OF_A, n_uA_OF_B, perfModel->EX_stage.get(8), perfModel->EX_substage_CUSTOM0});
perfModel->IS_stage = n_IS_stage;
// CUSTOM0
uint64_t n_CUSTOM0;
n_CUSTOM0 = n_IS_stage + 1;
perfModel->regModel.setXd(n_CUSTOM0);
// EX_substage_CUSTOM0
uint64_t n_EX_substage_CUSTOM0 = n_CUSTOM0;
perfModel->EX_substage_CUSTOM0 = n_EX_substage_CUSTOM0;
// EX_stage
uint64_t n_EX_stage;
n_EX_stage = std::max({n_EX_substage_CUSTOM0, perfModel->EX_stage.get(1), perfModel->COM_stage.get(2)});
perfModel->EX_stage.set(n_EX_stage);
// Commit
uint64_t n_Commit;
n_Commit = n_EX_stage + 1;

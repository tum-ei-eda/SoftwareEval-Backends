...
void CVA6XISAAC_PerformanceModel::connectChannel(Channel* channel_)
{
  CVA6XISAAC_Channel* channel = static_cast<CVA6XISAAC_Channel*>(channel_);
...
uint64_t CVA6XISAAC_PerformanceModel::getCycleCount(void)
{
...
std::string CVA6XISAAC_PerformanceModel::getPipelineStream(void)
{
...
std::string CVA6XISAAC_PerformanceModel::getPrintHeader(void)
{
  std::stringstream ret_strs;

...
#ifndef SWEVAL_BACKENDS_VICUNA_ZVL1024B_PERFORMANCE_MODEL_H
#define SWEVAL_BACKENDS_VICUNA_ZVL1024B_PERFORMANCE_MODEL_H
...
namespace Vicuna_zvl1024b{

extern SchedulingFunctionSet* Vicuna_zvl1024b_SchedulingFunctionSet;

class Vicuna_zvl1024b_PerformanceModel : public PerformanceModel
{
public:

  Vicuna_zvl1024b_PerformanceModel() : PerformanceModel("Vicuna_zvl1024b", Vicuna_zvl1024b_SchedulingFunctionSet)
    ,V_IQ_stg(2,0)
...
#endif // SWEVAL_BACKENDS_VICUNA_ZVL1024B_PERFORMANCE_MODEL_H
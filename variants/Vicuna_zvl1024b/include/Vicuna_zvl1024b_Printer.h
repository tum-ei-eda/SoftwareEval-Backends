...
#ifndef SWEVAL_BACKENDS_VICUNA_ZVL1024B_PRINTER_H
#define SWEVAL_BACKENDS_VICUNA_ZVL1024B_PRINTER_H
...
class Vicuna_zvl1024b_Printer : public Printer
{
public:

  Vicuna_zvl1024b_Printer();
  ...
  uint64_t get_vs1(void){ return vs1_ptr[instrIndex]; };
  ...
  uint64_t get_vm(void){ return vm_ptr[instrIndex]; };
  uint64_t get_vtype(void){ return vtype_ptr[instrIndex]; };
  uint64_t get_lsWidth(void){ return lsWidth_ptr[instrIndex]; };
  uint64_t get_nf(void){ return nf_ptr[instrIndex]; };
...
#endif // SWEVAL_BACKENDS_VICUNA_ZVL1024B_PRINTER_H
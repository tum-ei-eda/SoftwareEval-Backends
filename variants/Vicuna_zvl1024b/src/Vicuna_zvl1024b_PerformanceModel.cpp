...
void Vicuna_zvl1024b_PerformanceModel::connectChannel(Channel* channel_)
{
  Vicuna_zvl1024b_Channel* channel = static_cast<Vicuna_zvl1024b_Channel*>(channel_);
...
uint64_t Vicuna_zvl1024b_PerformanceModel::getCycleCount(void)
{
...
std::string Vicuna_zvl1024b_PerformanceModel::getPipelineStream(void)
{
...
std::string Vicuna_zvl1024b_PerformanceModel::getPrintHeader(void)
{
  std::stringstream ret_strs;

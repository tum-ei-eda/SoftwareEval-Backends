...
InstructionPrinterSet *Vicuna_zvl256b_InstrPrinterSet = new InstructionPrinterSet("Vicuna_zvl256b_InstrPrinterSet");

static InstructionPrinter *instrPrinter_add = new InstructionPrinter(
  Vicuna_zvl256b_InstrPrinterSet,
  "add",
  0,
  [](Printer* printer_){
    std::stringstream ret_strs;
    Vicuna_zvl256b_Printer* printer = static_cast<Vicuna_zvl256b_Printer*>(printer_);

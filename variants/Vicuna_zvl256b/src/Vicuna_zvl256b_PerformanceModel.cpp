...
void Vicuna_zvl256b_PerformanceModel::connectChannel(Channel* channel_)
{
  Vicuna_zvl256b_Channel* channel = static_cast<Vicuna_zvl256b_Channel*>(channel_);
...
uint64_t Vicuna_zvl256b_PerformanceModel::getCycleCount(void)
{
...
std::string Vicuna_zvl256b_PerformanceModel::getPipelineStream(void)
{
...
std::string Vicuna_zvl256b_PerformanceModel::getPrintHeader(void)
{
  std::stringstream ret_strs;

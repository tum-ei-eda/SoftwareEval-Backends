...
extern InstructionPrinterSet* Vicuna_zvl256b_InstrPrinterSet;

Vicuna_zvl256b_Printer::Vicuna_zvl256b_Printer(): Printer("Vicuna_zvl256b_Printer", Vicuna_zvl256b_InstrPrinterSet)
{}

void Vicuna_zvl256b_Printer::connectChannel(Channel* ch_)
{
  Vicuna_zvl256b_Channel* channel = static_cast<Vicuna_zvl256b_Channel*>(ch_);
...
std::string Vicuna_zvl256b_Printer::getPrintHeader(void)
{

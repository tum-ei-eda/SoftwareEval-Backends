...
void CV32E40PXCFU0_PerformanceModel::connectChannel(Channel* channel_)
{
  CV32E40PXCFU0_Channel* channel = static_cast<CV32E40PXCFU0_Channel*>(channel_);
...
uint64_t CV32E40PXCFU0_PerformanceModel::getCycleCount(void)
{
...
std::string CV32E40PXCFU0_PerformanceModel::getPipelineStream(void)
{
...
std::string CV32E40PXCFU0_PerformanceModel::getPrintHeader(void)
{
  std::stringstream ret_strs;

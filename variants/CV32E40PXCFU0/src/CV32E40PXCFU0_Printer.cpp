...
#include "CV32E40PXCFU0_Channel.h"

#include <iostream>
#include <iomanip>

extern InstructionPrinterSet* CV32E40PXCFU0_InstrPrinterSet;

CV32E40PXCFU0_Printer::CV32E40PXCFU0_Printer(): Printer("CV32E40PXCFU0_Printer", CV32E40PXCFU0_InstrPrinterSet)
{}

void CV32E40PXCFU0_Printer::connectChannel(Channel* ch_)
{
  CV32E40PXCFU0_Channel* channel = static_cast<CV32E40PXCFU0_Channel*>(ch_);
...
std::string CV32E40PXCFU0_Printer::getPrintHeader(void)
{

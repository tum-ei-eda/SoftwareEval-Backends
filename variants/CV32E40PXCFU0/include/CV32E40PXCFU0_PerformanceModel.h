...
#ifndef SWEVAL_BACKENDS_CV32E40PXCFU0_PERFORMANCE_MODEL_H
#define SWEVAL_BACKENDS_CV32E40PXCFU0_PERFORMANCE_MODEL_H
...
extern SchedulingFunctionSet* CV32E40PXCFU0_SchedulingFunctionSet;

class CV32E40PXCFU0_PerformanceModel : public PerformanceModel
{
public:

  CV32E40PXCFU0_PerformanceModel() : PerformanceModel("CV32E40PXCFU0", CV32E40PXCFU0_SchedulingFunctionSet)
    ,regModel(this)
...
#endif // SWEVAL_BACKENDS_CV32E40PXCFU0_PERFORMANCE_MODEL_H
...
extern InstructionPrinterSet* Vicuna_zvl128b_InstrPrinterSet;

Vicuna_zvl128b_Printer::Vicuna_zvl128b_Printer(): Printer("Vicuna_zvl128b_Printer", Vicuna_zvl128b_InstrPrinterSet)
{}

void Vicuna_zvl128b_Printer::connectChannel(Channel* ch_)
{
  Vicuna_zvl128b_Channel* channel = static_cast<Vicuna_zvl128b_Channel*>(ch_);
...
std::string Vicuna_zvl128b_Printer::getPrintHeader(void)
{

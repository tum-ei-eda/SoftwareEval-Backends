...
#ifndef SWEVAL_BACKENDS_VICUNA_ZVL128B_PRINTER_H
#define SWEVAL_BACKENDS_VICUNA_ZVL128B_PRINTER_H
...
class Vicuna_zvl128b_Printer : public Printer
{
public:

  Vicuna_zvl128b_Printer();
...
#endif // SWEVAL_BACKENDS_VICUNA_ZVL128B_PRINTER_H
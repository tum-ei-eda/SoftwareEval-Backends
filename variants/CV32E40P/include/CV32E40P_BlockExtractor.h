...
class CV32E40P_BlockExtractor : public BlockExtractor{

public:
    CV32E40P_BlockExtractor(){
        blockInstrGen = std::make_unique<CV32E40P_BlockInstructionGenerator>();
        outputPath = "CV32E40P_BlockList.json";
    };
    ~CV32E40P_BlockExtractor() = default;
    ...
    virtual void connectChannel(Channel* channel_){
        ...
        CV32E40P_Channel* spec_channel = static_cast<CV32E40P_Channel*>(channel_);

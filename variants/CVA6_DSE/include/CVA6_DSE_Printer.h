...
#ifndef SWEVAL_BACKENDS_CVA6_DSE_PRINTER_H
#define SWEVAL_BACKENDS_CVA6_DSE_PRINTER_H
...
class CVA6_DSE_Printer : public Printer
{
public:
...
#endif // SWEVAL_BACKENDS_CVA6_DSE_PRINTER_H
...
void CVA6_DSE_PerformanceModel::connectChannel(Channel* channel_)
{
...
uint64_t CVA6_DSE_PerformanceModel::getCycleCount(void)
{
...
std::string CVA6_DSE_PerformanceModel::getPipelineStream(void)
{
...
std::string CVA6_DSE_PerformanceModel::getPrintHeader(void)
{
  std::stringstream ret_strs;
  ret_strs << "Enter";
  ret_strs << "," << "PC_stage";

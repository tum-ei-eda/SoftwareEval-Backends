...
InstructionPrinterSet *CVA6_DSE_InstrPrinterSet = new InstructionPrinterSet("CVA6_DSE_InstrPrinterSet");

static InstructionPrinter *instrPrinter__def = new InstructionPrinter(
  CVA6_DSE_InstrPrinterSet,
  "_def",
  0,
  [](Printer* printer_){
    std::stringstream ret_strs;
    CVA6_DSE_Printer* printer = static_cast<CVA6_DSE_Printer*>(printer_);

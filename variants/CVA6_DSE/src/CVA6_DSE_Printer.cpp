...
extern InstructionPrinterSet* CVA6_DSE_InstrPrinterSet;

CVA6_DSE_Printer::CVA6_DSE_Printer(): Printer("CVA6_DSE_Printer", CVA6_DSE_InstrPrinterSet)
{}

void CVA6_DSE_Printer::connectChannel(Channel* ch_)
{
  CVA6_DSE_Channel* channel = static_cast<CVA6_DSE_Channel*>(ch_);
...
std::string CVA6_DSE_Printer::getPrintHeader(void)
{

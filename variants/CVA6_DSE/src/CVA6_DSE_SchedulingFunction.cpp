...
SchedulingFunctionSet* CVA6_DSE_SchedulingFunctionSet = new SchedulingFunctionSet("CVA6_DSE_SchedulingFunctionSet");

static SchedulingFunction *schedulingFunction__def = new SchedulingFunction(
  CVA6_DSE_SchedulingFunctionSet,
  "_def",
  0,
  [](PerformanceModel* perfModel_){
  CVA6_DSE_PerformanceModel* perfModel = static_cast<CVA6_DSE_PerformanceModel*>(perfModel_);
  // Enter
...
// PC_stage
uint64_t n_PC_stage;
n_PC_stage = std::max({n_PCGen, n_uA_PcCorrect, perfModel->IF_stage.get(9), perfModel->IF_substage_0});
...
// ICache
uint64_t n_ICache;
n_ICache = n_IF_substage_0 + perfModel->iCache.getDelay();
// IF_substage_1
...
perfModel->IF_substage_2 = n_IF_substage_2;
// IF_stage
uint64_t n_IF_stage;
n_IF_stage = std::max({n_IF_substage_2, perfModel->IF_stage.get(1), perfModel->ID_stage});
...
// DCache
uint64_t n_DCache;
n_DCache = n_EX_substage_lCtrl + perfModel->dCache.getDelay();
// EX_substage_dCache

...
static void block_58_fn(uint64_t* vec_, uint8_t* d_){
	...
	uint64_t out_67 = MAP_Explorer::max2(vec_[0] +7+t_25, vec_[1] +6+d_[1]);
	out_67 = MAP_Explorer::max2(out_67, vec_[6] +6+d_[4]);
	out_67 = MAP_Explorer::max2(out_67, vec_[7] +6+t_19);
	out_67 = MAP_Explorer::max2(out_67, vec_[8] +6+t_23);
	out_67 = MAP_Explorer::max2(out_67, vec_[9] +6+t_25);
	out_67 = MAP_Explorer::max2(out_67, vec_[10] +6+t_25);
	out_67 = MAP_Explorer::max2(out_67, vec_[11] +5+t_25);
	out_67 = MAP_Explorer::max2(out_67, vec_[12] +5+t_27);
	...
	out_67 = MAP_Explorer::max2(out_67, vec_[98] +6+t_25);
	out_67 = MAP_Explorer::max2(out_67, vec_[99] +5+t_25);
	...
	out_84 = MAP_Explorer::max2(out_84, vec_[36] +3+d_[1]);
	out_84 = MAP_Explorer::max2(out_84, vec_[44] +2);
	out_84 = MAP_Explorer::max2(out_84, vec_[77] +3+d_[1]);

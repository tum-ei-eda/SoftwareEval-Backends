...
static void block_295_fn(uint64_t* vec_, uint8_t* d_){
	...
	out_18 = MAP_Explorer::max2(out_18, vec_[84] +4);
	out_18 = MAP_Explorer::max2(out_18, vec_[98] +5+t_8);
	out_18 = MAP_Explorer::max2(out_18, vec_[99] +4+t_8);
	uint64_t out_48 = MAP_Explorer::max2(vec_[0] +6+t_20, vec_[1] +7);
	out_48 = MAP_Explorer::max2(out_48, vec_[6] +5+d_[3]);
	out_48 = MAP_Explorer::max2(out_48, vec_[7] +5+t_15);
	out_48 = MAP_Explorer::max2(out_48, vec_[8] +5+t_21);
	...
	out_48 = MAP_Explorer::max2(out_48, vec_[12] +4+t_21);
	...
	out_48 = MAP_Explorer::max2(out_48, vec_[44] +5);
	out_48 = MAP_Explorer::max2(out_48, vec_[49] +1);
	out_48 = MAP_Explorer::max2(out_48, vec_[76] +4);
	out_48 = MAP_Explorer::max2(out_48, vec_[84] +5);

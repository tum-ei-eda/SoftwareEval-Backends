...
static void block_365_fn(uint64_t* vec_, uint8_t* d_){
	...
	out_52 = MAP_Explorer::max2(out_52, vec_[7] +5+t_15);
	out_52 = MAP_Explorer::max2(out_52, vec_[8] +5+t_21);
	...
	out_52 = MAP_Explorer::max2(out_52, vec_[12] +4+t_21);
	...
	out_52 = MAP_Explorer::max2(out_52, vec_[48] +5);
	out_52 = MAP_Explorer::max2(out_52, vec_[52] +1);
	out_52 = MAP_Explorer::max2(out_52, vec_[79] +5);
	...
	out_80 = MAP_Explorer::max2(out_80, vec_[79] +5);

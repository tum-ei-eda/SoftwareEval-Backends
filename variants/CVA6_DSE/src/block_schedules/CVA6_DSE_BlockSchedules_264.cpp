...
static void block_288_fn(uint64_t* vec_, uint8_t* d_){
	...
	uint64_t out_13 = MAP_Explorer::max2(out_1 +1, vec_[15] +1);
	...
	out_19 = MAP_Explorer::max2(out_19, vec_[84] +2);
	uint64_t out_49 = MAP_Explorer::max2(out_4 +3, vec_[20] +1);
	...
	uint64_t out_59 = MAP_Explorer::max2(out_3 +3, vec_[19] +1);
	...
	uint64_t out_90 = MAP_Explorer::max2(out_2 +4, vec_[15] +3);

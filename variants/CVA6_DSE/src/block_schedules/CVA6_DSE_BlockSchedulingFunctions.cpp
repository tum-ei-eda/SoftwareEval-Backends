...
const std::array<const MAP_Explorer::Block*, 735> CVA6_DSE_blocks{{
    &block_305,
    &block_308,
    &block_309,
    &block_306,
...
extern const MAP_Explorer::BlockDictionary CVA6_DSE_blockDict{CVA6_DSE_blocks.data(), CVA6_DSE_blocks.size()};

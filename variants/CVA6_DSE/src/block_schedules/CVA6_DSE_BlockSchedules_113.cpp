...
static void block_620_fn(uint64_t* vec_, uint8_t* d_){
	...
	out_47 = MAP_Explorer::max2(out_47, vec_[48] +4);
	out_47 = MAP_Explorer::max2(out_47, vec_[96] +4);
	...
	out_64 = MAP_Explorer::max2(out_64, vec_[48] +3);
	...
	out_18 = MAP_Explorer::max2(out_18, vec_[96] +1);

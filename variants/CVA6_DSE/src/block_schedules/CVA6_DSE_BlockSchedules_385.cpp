...
static void block_770_fn(uint64_t* vec_, uint8_t* d_){
	...
	uint64_t t_33 = MAP_Explorer::max2(+t_32, +2+t_4);
	uint64_t t_34 = MAP_Explorer::max2(+t_31, +t_20);
	uint64_t t_35 = MAP_Explorer::max2(+t_34, +2+d_[2]+d_[3]);
	uint64_t t_36 = MAP_Explorer::max2(+t_31, +t_21);
	...
	uint64_t out_32 = MAP_Explorer::max2(vec_[0] +7+t_33, vec_[1] +6+t_6);
	...
	out_32 = MAP_Explorer::max2(out_32, vec_[53] +4+t_6);
	out_32 = MAP_Explorer::max2(out_32, vec_[75] +4+d_[3]);
	out_32 = MAP_Explorer::max2(out_32, vec_[85] +3);
	out_32 = MAP_Explorer::max2(out_32, vec_[88] +4+t_6);
	out_32 = MAP_Explorer::max2(out_32, vec_[98] +6+t_33);
	out_32 = MAP_Explorer::max2(out_32, vec_[99] +5+t_33);
	uint64_t out_43 = MAP_Explorer::max2(vec_[0] +7+t_11, vec_[1] +4+d_[1]+d_[3]);
	out_43 = MAP_Explorer::max2(out_43, vec_[8] +6+d_[2]+d_[3]);
	out_43 = MAP_Explorer::max2(out_43, vec_[9] +6+t_11);
	out_43 = MAP_Explorer::max2(out_43, vec_[10] +6+t_11);
	out_43 = MAP_Explorer::max2(out_43, vec_[11] +5+t_11);
	out_43 = MAP_Explorer::max2(out_43, vec_[12] +5+t_12);
	...
	out_43 = MAP_Explorer::max2(out_43, vec_[98] +6+t_11);
	out_43 = MAP_Explorer::max2(out_43, vec_[99] +5+t_11);
	uint64_t out_75 = MAP_Explorer::max2(vec_[0] +8+t_4, vec_[1] +5+t_6);
	out_75 = MAP_Explorer::max2(out_75, vec_[8] +7+d_[2]+d_[3]);
	out_75 = MAP_Explorer::max2(out_75, vec_[9] +7+t_4);
	out_75 = MAP_Explorer::max2(out_75, vec_[10] +7+t_4);
	out_75 = MAP_Explorer::max2(out_75, vec_[11] +6+t_4);
	out_75 = MAP_Explorer::max2(out_75, vec_[12] +6+t_8);
	out_75 = MAP_Explorer::max2(out_75, vec_[13] +5+t_6);
	out_75 = MAP_Explorer::max2(out_75, vec_[14] +4+t_6);
	out_75 = MAP_Explorer::max2(out_75, vec_[15] +1);
	out_75 = MAP_Explorer::max2(out_75, vec_[21] +3+d_[3]);
	out_75 = MAP_Explorer::max2(out_75, vec_[22] +3+t_6);
	out_75 = MAP_Explorer::max2(out_75, vec_[27] +3+t_6);
	out_75 = MAP_Explorer::max2(out_75, vec_[28] +2+t_6);
	...
	out_75 = MAP_Explorer::max2(out_75, vec_[53] +3+t_6);
	out_75 = MAP_Explorer::max2(out_75, vec_[75] +3+d_[3]);
	out_75 = MAP_Explorer::max2(out_75, vec_[88] +3+t_6);
	out_75 = MAP_Explorer::max2(out_75, vec_[98] +7+t_4);
	out_75 = MAP_Explorer::max2(out_75, vec_[99] +6+t_4);
	uint64_t out_85 = MAP_Explorer::max2(vec_[0] +7+t_19, vec_[1] +5+t_6);
	out_85 = MAP_Explorer::max2(out_85, vec_[7] +6+d_[4]);
	out_85 = MAP_Explorer::max2(out_85, vec_[8] +6+t_20);
	out_85 = MAP_Explorer::max2(out_85, vec_[9] +6+t_19);
	out_85 = MAP_Explorer::max2(out_85, vec_[10] +6+t_19);
	out_85 = MAP_Explorer::max2(out_85, vec_[11] +5+t_19);
	out_85 = MAP_Explorer::max2(out_85, vec_[12] +5+t_21);
	out_85 = MAP_Explorer::max2(out_85, vec_[13] +5+t_6);
	out_85 = MAP_Explorer::max2(out_85, vec_[14] +4+t_6);
	...
	out_85 = MAP_Explorer::max2(out_85, vec_[22] +3+t_6);
	...
	out_85 = MAP_Explorer::max2(out_85, vec_[27] +3+t_6);
	out_85 = MAP_Explorer::max2(out_85, vec_[28] +2+t_6);
	...
	out_85 = MAP_Explorer::max2(out_85, vec_[53] +3+t_6);
	out_85 = MAP_Explorer::max2(out_85, vec_[75] +3+d_[3]);
	out_85 = MAP_Explorer::max2(out_85, vec_[85] +2);
	out_85 = MAP_Explorer::max2(out_85, vec_[88] +3+t_6);
	out_85 = MAP_Explorer::max2(out_85, vec_[98] +6+t_19);
	out_85 = MAP_Explorer::max2(out_85, vec_[99] +5+t_19);
...
extern const MAP_Explorer::Block block_770{
    770,
    2147566956,
    2147566968,
    block_770_fn

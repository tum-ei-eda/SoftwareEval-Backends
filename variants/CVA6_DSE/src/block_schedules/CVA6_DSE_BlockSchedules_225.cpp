...
static void block_319_fn(uint64_t* vec_, uint8_t* d_){
	...
	uint64_t out_86 = MAP_Explorer::max2(vec_[0] +7+t_8, vec_[1] +7);
	out_86 = MAP_Explorer::max2(out_86, vec_[7] +6+d_[2]);
	out_86 = MAP_Explorer::max2(out_86, vec_[8] +6+t_9);
	out_86 = MAP_Explorer::max2(out_86, vec_[9] +6+t_8);
	out_86 = MAP_Explorer::max2(out_86, vec_[10] +6+t_8);
	out_86 = MAP_Explorer::max2(out_86, vec_[11] +5+t_8);
	out_86 = MAP_Explorer::max2(out_86, vec_[12] +5+t_9);
	...
	out_86 = MAP_Explorer::max2(out_86, vec_[44] +5);
	out_86 = MAP_Explorer::max2(out_86, vec_[76] +5);
	out_86 = MAP_Explorer::max2(out_86, vec_[86] +4);
	out_86 = MAP_Explorer::max2(out_86, vec_[98] +6+t_8);
	out_86 = MAP_Explorer::max2(out_86, vec_[99] +5+t_8);
	...
	out_17 = MAP_Explorer::max2(out_17, vec_[86] +1);

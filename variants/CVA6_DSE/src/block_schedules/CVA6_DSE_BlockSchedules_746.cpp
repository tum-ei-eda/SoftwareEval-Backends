...
static void block_661_fn(uint64_t* vec_, uint8_t* d_){
	...
	uint64_t out_68 = MAP_Explorer::max2(vec_[0] +7+t_11, vec_[1] +6+d_[1]);
	out_68 = MAP_Explorer::max2(out_68, vec_[7] +6+d_[3]);
	out_68 = MAP_Explorer::max2(out_68, vec_[8] +6+t_9);
	out_68 = MAP_Explorer::max2(out_68, vec_[9] +6+t_11);
	out_68 = MAP_Explorer::max2(out_68, vec_[10] +6+t_11);
	out_68 = MAP_Explorer::max2(out_68, vec_[11] +5+t_11);
	out_68 = MAP_Explorer::max2(out_68, vec_[12] +5+t_13);
	...
	out_68 = MAP_Explorer::max2(out_68, vec_[98] +6+t_11);
	out_68 = MAP_Explorer::max2(out_68, vec_[99] +5+t_11);

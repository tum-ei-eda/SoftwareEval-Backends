...
static void block_323_fn(uint64_t* vec_, uint8_t* d_){
	...
	out_19 = MAP_Explorer::max2(out_19, vec_[52] +1);
	...
	uint64_t out_48 = MAP_Explorer::max2(out_2 +3, vec_[15] +2);
	...
	out_48 = MAP_Explorer::max2(out_48, vec_[90] +2);
	uint64_t out_58 = MAP_Explorer::max2(out_3 +3, vec_[20] +1);
	out_58 = MAP_Explorer::max2(out_58, vec_[21] +2);
	out_58 = MAP_Explorer::max2(out_58, vec_[79] +2);

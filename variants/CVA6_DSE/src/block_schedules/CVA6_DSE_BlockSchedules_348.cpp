...
static void block_488_fn(uint64_t* vec_, uint8_t* d_){
	...
	uint64_t out_32 = MAP_Explorer::max2(vec_[0] +7+t_59, vec_[1] +9);
	out_32 = MAP_Explorer::max2(out_32, vec_[4] +6+d_[5]);
	out_32 = MAP_Explorer::max2(out_32, vec_[5] +6+t_45);
	out_32 = MAP_Explorer::max2(out_32, vec_[6] +6+t_49);
	...
	out_75 = MAP_Explorer::max2(out_75, vec_[8] +6+t_39);
	...
	out_75 = MAP_Explorer::max2(out_75, vec_[12] +5+t_39);
	...
	out_75 = MAP_Explorer::max2(out_75, vec_[47] +2);
	out_75 = MAP_Explorer::max2(out_75, vec_[75] +2);
	out_75 = MAP_Explorer::max2(out_75, vec_[80] +6);
	out_75 = MAP_Explorer::max2(out_75, vec_[98] +6+t_37);
	out_75 = MAP_Explorer::max2(out_75, vec_[99] +5+t_37);
	uint64_t out_80 = MAP_Explorer::max2(vec_[0] +7+t_20, vec_[1] +7);
	...
	out_80 = MAP_Explorer::max2(out_80, vec_[9] +6+t_20);
	out_80 = MAP_Explorer::max2(out_80, vec_[10] +6+t_20);
	out_80 = MAP_Explorer::max2(out_80, vec_[11] +5+t_20);
	...
	out_80 = MAP_Explorer::max2(out_80, vec_[98] +6+t_20);
	out_80 = MAP_Explorer::max2(out_80, vec_[99] +5+t_20);
	...
	uint64_t out_43 = MAP_Explorer::max2(out_2 +3, vec_[15] +3);
	...
	out_43 = MAP_Explorer::max2(out_43, vec_[47] +1);
	uint64_t out_46 = MAP_Explorer::max2(out_5 +3, vec_[21] +1);
	...
	uint64_t out_48 = MAP_Explorer::max2(out_3 +3, vec_[15] +2);

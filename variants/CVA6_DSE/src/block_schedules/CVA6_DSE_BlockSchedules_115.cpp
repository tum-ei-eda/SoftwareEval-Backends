...
static void block_618_fn(uint64_t* vec_, uint8_t* d_){
	...
	out_1 = MAP_Explorer::max2(out_1, vec_[97] +2);
	...
	uint64_t out_64 = MAP_Explorer::max2(vec_[0] +6+t_10, vec_[1] +6);
	out_64 = MAP_Explorer::max2(out_64, vec_[7] +5+d_[2]);
	out_64 = MAP_Explorer::max2(out_64, vec_[8] +5+t_9);
	out_64 = MAP_Explorer::max2(out_64, vec_[9] +5+t_10);
	out_64 = MAP_Explorer::max2(out_64, vec_[10] +5+t_10);
	out_64 = MAP_Explorer::max2(out_64, vec_[11] +4+t_10);
	out_64 = MAP_Explorer::max2(out_64, vec_[12] +4+t_11);
	out_64 = MAP_Explorer::max2(out_64, vec_[13] +6);
	out_64 = MAP_Explorer::max2(out_64, vec_[14] +5);
	out_64 = MAP_Explorer::max2(out_64, vec_[15] +3);
	out_64 = MAP_Explorer::max2(out_64, vec_[20] +1);
	out_64 = MAP_Explorer::max2(out_64, vec_[21] +2);
	out_64 = MAP_Explorer::max2(out_64, vec_[22] +4);
	out_64 = MAP_Explorer::max2(out_64, vec_[23] +4);
	out_64 = MAP_Explorer::max2(out_64, vec_[25] +4);
	out_64 = MAP_Explorer::max2(out_64, vec_[26] +4);
	out_64 = MAP_Explorer::max2(out_64, vec_[33] +3);
	out_64 = MAP_Explorer::max2(out_64, vec_[34] +1);
	out_64 = MAP_Explorer::max2(out_64, vec_[48] +4);
	out_64 = MAP_Explorer::max2(out_64, vec_[97] +4);
	out_64 = MAP_Explorer::max2(out_64, vec_[98] +5+t_10);
	out_64 = MAP_Explorer::max2(out_64, vec_[99] +4+t_10);
	uint64_t out_65 = MAP_Explorer::max2(vec_[0] +6+t_2, vec_[1] +5);
	out_65 = MAP_Explorer::max2(out_65, vec_[8] +5+d_[1]);
	out_65 = MAP_Explorer::max2(out_65, vec_[9] +5+t_2);
	out_65 = MAP_Explorer::max2(out_65, vec_[10] +5+t_2);
	out_65 = MAP_Explorer::max2(out_65, vec_[11] +4+t_2);
	out_65 = MAP_Explorer::max2(out_65, vec_[12] +4+t_3);
	out_65 = MAP_Explorer::max2(out_65, vec_[13] +5);
	out_65 = MAP_Explorer::max2(out_65, vec_[14] +4);
	out_65 = MAP_Explorer::max2(out_65, vec_[15] +2);
	out_65 = MAP_Explorer::max2(out_65, vec_[21] +1);
	out_65 = MAP_Explorer::max2(out_65, vec_[22] +3);
	out_65 = MAP_Explorer::max2(out_65, vec_[23] +3);
	out_65 = MAP_Explorer::max2(out_65, vec_[25] +3);
	out_65 = MAP_Explorer::max2(out_65, vec_[26] +3);
	out_65 = MAP_Explorer::max2(out_65, vec_[33] +2);
	out_65 = MAP_Explorer::max2(out_65, vec_[48] +3);
	out_65 = MAP_Explorer::max2(out_65, vec_[97] +3);
	out_65 = MAP_Explorer::max2(out_65, vec_[98] +5+t_2);
	out_65 = MAP_Explorer::max2(out_65, vec_[99] +4+t_2);
	...
	out_13 = MAP_Explorer::max2(out_13, vec_[96] );
	...
	out_18 = MAP_Explorer::max2(out_18, vec_[97] +1);
	uint64_t out_96 = MAP_Explorer::max2(out_64 +1, vec_[32] +1);
	out_96 = MAP_Explorer::max2(out_96, vec_[96] +2);
	uint64_t out_97 = MAP_Explorer::max2(out_65 +1, vec_[32] +1);

...
static void block_364_fn(uint64_t* vec_, uint8_t* d_){
	...
	uint64_t out_80 = MAP_Explorer::max2(vec_[0] +7+t_37, vec_[1] +8);
	out_80 = MAP_Explorer::max2(out_80, vec_[5] +6+d_[4]);
	out_80 = MAP_Explorer::max2(out_80, vec_[6] +6+t_27);
	out_80 = MAP_Explorer::max2(out_80, vec_[7] +6+t_31);
	...
	out_80 = MAP_Explorer::max2(out_80, vec_[12] +5+t_39);
	...
	uint64_t out_48 = MAP_Explorer::max2(out_2 +3, vec_[15] +3);

...
static void block_181_fn(uint64_t* vec_, uint8_t* d_){
	...
	out_27 = MAP_Explorer::max2(out_27, vec_[52] +1+d_[1]);
	...
	out_32 = MAP_Explorer::max2(out_32, vec_[52] +4+t_6);
	out_32 = MAP_Explorer::max2(out_32, vec_[75] +4+t_6);
	...
	uint64_t out_59 = MAP_Explorer::max2(vec_[0] +7+t_11, vec_[1] +4+d_[1]+d_[3]);
	out_59 = MAP_Explorer::max2(out_59, vec_[8] +6+d_[2]+d_[3]);
	out_59 = MAP_Explorer::max2(out_59, vec_[9] +6+t_11);
	out_59 = MAP_Explorer::max2(out_59, vec_[10] +6+t_11);
	out_59 = MAP_Explorer::max2(out_59, vec_[11] +5+t_11);
	out_59 = MAP_Explorer::max2(out_59, vec_[12] +5+t_12);
	out_59 = MAP_Explorer::max2(out_59, vec_[13] +4+d_[1]+d_[3]);
	out_59 = MAP_Explorer::max2(out_59, vec_[14] +3+d_[1]+d_[3]);
	out_59 = MAP_Explorer::max2(out_59, vec_[21] +2+d_[3]);
	out_59 = MAP_Explorer::max2(out_59, vec_[22] +2+d_[1]+d_[3]);
	out_59 = MAP_Explorer::max2(out_59, vec_[27] +2+d_[1]+d_[3]);
	out_59 = MAP_Explorer::max2(out_59, vec_[28] +1+d_[1]+d_[3]);
	out_59 = MAP_Explorer::max2(out_59, vec_[29] +1+d_[3]);
	out_59 = MAP_Explorer::max2(out_59, vec_[52] +2+d_[1]+d_[3]);
	out_59 = MAP_Explorer::max2(out_59, vec_[75] +2+d_[1]+d_[3]);
	out_59 = MAP_Explorer::max2(out_59, vec_[98] +6+t_11);
	out_59 = MAP_Explorer::max2(out_59, vec_[99] +5+t_11);
	uint64_t out_84 = MAP_Explorer::max2(vec_[0] +7+t_19, vec_[1] +5+t_6);
	out_84 = MAP_Explorer::max2(out_84, vec_[7] +6+d_[4]);
	out_84 = MAP_Explorer::max2(out_84, vec_[8] +6+t_20);
	out_84 = MAP_Explorer::max2(out_84, vec_[9] +6+t_19);
	out_84 = MAP_Explorer::max2(out_84, vec_[10] +6+t_19);
	out_84 = MAP_Explorer::max2(out_84, vec_[11] +5+t_19);
	out_84 = MAP_Explorer::max2(out_84, vec_[12] +5+t_21);
	out_84 = MAP_Explorer::max2(out_84, vec_[13] +5+t_6);
	out_84 = MAP_Explorer::max2(out_84, vec_[14] +4+t_6);
	out_84 = MAP_Explorer::max2(out_84, vec_[15] +2);
	out_84 = MAP_Explorer::max2(out_84, vec_[20] +2);
	out_84 = MAP_Explorer::max2(out_84, vec_[21] +3+d_[3]);
	out_84 = MAP_Explorer::max2(out_84, vec_[22] +3+t_6);
	...
	out_84 = MAP_Explorer::max2(out_84, vec_[27] +3+t_6);
	out_84 = MAP_Explorer::max2(out_84, vec_[28] +2+t_6);
	out_84 = MAP_Explorer::max2(out_84, vec_[29] +2+d_[3]);
	out_84 = MAP_Explorer::max2(out_84, vec_[32] +1);
	out_84 = MAP_Explorer::max2(out_84, vec_[33] +2);
	out_84 = MAP_Explorer::max2(out_84, vec_[52] +3+t_6);
	out_84 = MAP_Explorer::max2(out_84, vec_[75] +3+t_6);
	out_84 = MAP_Explorer::max2(out_84, vec_[84] +2);
	out_84 = MAP_Explorer::max2(out_84, vec_[91] +3+d_[3]);
	out_84 = MAP_Explorer::max2(out_84, vec_[98] +6+t_19);
	out_84 = MAP_Explorer::max2(out_84, vec_[99] +5+t_19);
	uint64_t out_91 = MAP_Explorer::max2(vec_[0] +8+t_4, vec_[1] +5+t_6);
	out_91 = MAP_Explorer::max2(out_91, vec_[8] +7+d_[2]+d_[3]);
	out_91 = MAP_Explorer::max2(out_91, vec_[9] +7+t_4);
	out_91 = MAP_Explorer::max2(out_91, vec_[10] +7+t_4);
	out_91 = MAP_Explorer::max2(out_91, vec_[11] +6+t_4);
	out_91 = MAP_Explorer::max2(out_91, vec_[12] +6+t_8);
	out_91 = MAP_Explorer::max2(out_91, vec_[13] +5+t_6);
	out_91 = MAP_Explorer::max2(out_91, vec_[14] +4+t_6);
	out_91 = MAP_Explorer::max2(out_91, vec_[15] +1);
	out_91 = MAP_Explorer::max2(out_91, vec_[21] +3+d_[3]);
	out_91 = MAP_Explorer::max2(out_91, vec_[22] +3+t_6);
	out_91 = MAP_Explorer::max2(out_91, vec_[27] +3+t_6);
	out_91 = MAP_Explorer::max2(out_91, vec_[28] +2+t_6);
	out_91 = MAP_Explorer::max2(out_91, vec_[29] +2+d_[3]);
	out_91 = MAP_Explorer::max2(out_91, vec_[32] +1);
	out_91 = MAP_Explorer::max2(out_91, vec_[33] +1);
	out_91 = MAP_Explorer::max2(out_91, vec_[52] +3+t_6);
	out_91 = MAP_Explorer::max2(out_91, vec_[75] +3+t_6);
	out_91 = MAP_Explorer::max2(out_91, vec_[91] +3+d_[3]);
	out_91 = MAP_Explorer::max2(out_91, vec_[98] +7+t_4);
	out_91 = MAP_Explorer::max2(out_91, vec_[99] +6+t_4);

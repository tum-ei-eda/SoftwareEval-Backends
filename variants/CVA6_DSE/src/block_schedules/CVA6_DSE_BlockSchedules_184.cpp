...
static void block_273_fn(uint64_t* vec_, uint8_t* d_){
	...
	uint64_t out_51 = MAP_Explorer::max2(vec_[0] +6+t_10, vec_[1] +6);
	out_51 = MAP_Explorer::max2(out_51, vec_[7] +5+d_[2]);
	out_51 = MAP_Explorer::max2(out_51, vec_[8] +5+t_9);
	out_51 = MAP_Explorer::max2(out_51, vec_[9] +5+t_10);
	out_51 = MAP_Explorer::max2(out_51, vec_[10] +5+t_10);
	out_51 = MAP_Explorer::max2(out_51, vec_[11] +4+t_10);
	out_51 = MAP_Explorer::max2(out_51, vec_[12] +4+t_11);
	...
	out_51 = MAP_Explorer::max2(out_51, vec_[44] +4);
	out_51 = MAP_Explorer::max2(out_51, vec_[45] +4);
	out_51 = MAP_Explorer::max2(out_51, vec_[46] +1);
	out_51 = MAP_Explorer::max2(out_51, vec_[81] +4);
	out_51 = MAP_Explorer::max2(out_51, vec_[98] +5+t_10);
	out_51 = MAP_Explorer::max2(out_51, vec_[99] +4+t_10);

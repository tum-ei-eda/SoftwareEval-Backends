...
static void block_334_fn(uint64_t* vec_, uint8_t* d_){
	...
	out_13 = MAP_Explorer::max2(out_13, vec_[86] +4);
	...
	out_17 = MAP_Explorer::max2(out_17, vec_[86] +3);
	out_17 = MAP_Explorer::max2(out_17, vec_[98] +5+t_2);
	out_17 = MAP_Explorer::max2(out_17, vec_[99] +4+t_2);
	uint64_t out_86 = MAP_Explorer::max2(vec_[0] +7+t_12, vec_[1] +8);
	out_86 = MAP_Explorer::max2(out_86, vec_[7] +6+d_[2]);
	out_86 = MAP_Explorer::max2(out_86, vec_[8] +6+t_13);
	out_86 = MAP_Explorer::max2(out_86, vec_[9] +6+t_12);
	out_86 = MAP_Explorer::max2(out_86, vec_[10] +6+t_12);
	out_86 = MAP_Explorer::max2(out_86, vec_[11] +5+t_12);
	out_86 = MAP_Explorer::max2(out_86, vec_[12] +5+t_14);
	...
	out_86 = MAP_Explorer::max2(out_86, vec_[48] +6);
	out_86 = MAP_Explorer::max2(out_86, vec_[54] +6);
	out_86 = MAP_Explorer::max2(out_86, vec_[86] +6);
	out_86 = MAP_Explorer::max2(out_86, vec_[98] +6+t_12);
	out_86 = MAP_Explorer::max2(out_86, vec_[99] +5+t_12);

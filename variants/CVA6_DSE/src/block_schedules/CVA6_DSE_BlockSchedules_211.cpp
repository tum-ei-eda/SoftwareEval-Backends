...
static void block_472_fn(uint64_t* vec_, uint8_t* d_){
	...
	uint64_t out_33 = MAP_Explorer::max2(vec_[0] +7+t_20, vec_[1] +8);
	out_33 = MAP_Explorer::max2(out_33, vec_[6] +7+d_[3]);
	out_33 = MAP_Explorer::max2(out_33, vec_[7] +7+t_15);
	out_33 = MAP_Explorer::max2(out_33, vec_[8] +6+t_21);
	out_33 = MAP_Explorer::max2(out_33, vec_[9] +6+t_20);
	out_33 = MAP_Explorer::max2(out_33, vec_[10] +6+t_20);
	out_33 = MAP_Explorer::max2(out_33, vec_[11] +5+t_20);
	...
	out_33 = MAP_Explorer::max2(out_33, vec_[98] +6+t_20);
	out_33 = MAP_Explorer::max2(out_33, vec_[99] +5+t_20);
	uint64_t out_67 = MAP_Explorer::max2(vec_[0] +7+t_37, vec_[1] +8);
	out_67 = MAP_Explorer::max2(out_67, vec_[5] +6+d_[4]);
	out_67 = MAP_Explorer::max2(out_67, vec_[6] +6+t_27);
	out_67 = MAP_Explorer::max2(out_67, vec_[7] +6+t_31);
	out_67 = MAP_Explorer::max2(out_67, vec_[8] +6+t_39);
	...
	out_67 = MAP_Explorer::max2(out_67, vec_[12] +5+t_39);
	...
	out_67 = MAP_Explorer::max2(out_67, vec_[49] +4);
	out_67 = MAP_Explorer::max2(out_67, vec_[50] +3);

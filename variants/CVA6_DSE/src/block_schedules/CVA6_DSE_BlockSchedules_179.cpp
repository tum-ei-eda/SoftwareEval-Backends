...
static void block_796_fn(uint64_t* vec_, uint8_t* d_){
	...
	out_32 = MAP_Explorer::max2(out_32, vec_[49] +3+t_17);
	out_32 = MAP_Explorer::max2(out_32, vec_[80] +3+t_17);
	...
	out_33 = MAP_Explorer::max2(out_33, vec_[49] +3+t_17);
	out_33 = MAP_Explorer::max2(out_33, vec_[80] +3+t_17);
	...
	out_81 = MAP_Explorer::max2(out_81, vec_[49] +3+d_[1]);

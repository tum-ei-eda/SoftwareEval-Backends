...
static void block_767_fn(uint64_t* vec_, uint8_t* d_){
	...
	out_44 = MAP_Explorer::max2(out_44, vec_[55] +2);
	...
	out_45 = MAP_Explorer::max2(out_45, vec_[55] +1);
...
extern const MAP_Explorer::Block block_767{
    767,
    2147547172,
    2147547184,
    block_767_fn

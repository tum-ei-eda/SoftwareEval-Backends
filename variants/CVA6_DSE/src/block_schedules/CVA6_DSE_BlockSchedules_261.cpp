...
static void block_285_fn(uint64_t* vec_, uint8_t* d_){
	...
	out_19 = MAP_Explorer::max2(out_19, vec_[43] +1);
	out_19 = MAP_Explorer::max2(out_19, vec_[75] +1);
	uint64_t out_43 = MAP_Explorer::max2(out_3 +3, vec_[15] +2);
	...
	uint64_t out_52 = MAP_Explorer::max2(out_2 +3, vec_[15] +3);
	...
	uint64_t out_84 = MAP_Explorer::max2(out_52 +1, vec_[32] +2);

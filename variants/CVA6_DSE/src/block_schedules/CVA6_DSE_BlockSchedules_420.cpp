...
static void block_85_fn(uint64_t* vec_, uint8_t* d_){
	...
	uint64_t out_1 = MAP_Explorer::max2(vec_[0] +3+t_30, vec_[1] +5);
	out_1 = MAP_Explorer::max2(out_1, vec_[5] +2+d_[4]);
	out_1 = MAP_Explorer::max2(out_1, vec_[6] +2+t_32);
	out_1 = MAP_Explorer::max2(out_1, vec_[7] +2+t_36);
	out_1 = MAP_Explorer::max2(out_1, vec_[8] +2+t_40);
	out_1 = MAP_Explorer::max2(out_1, vec_[9] +2+t_30);
	out_1 = MAP_Explorer::max2(out_1, vec_[10] +2+t_30);
	out_1 = MAP_Explorer::max2(out_1, vec_[11] +1+t_30);
	out_1 = MAP_Explorer::max2(out_1, vec_[12] +1+t_44);
	...
	out_1 = MAP_Explorer::max2(out_1, vec_[98] +2+t_30);
	out_1 = MAP_Explorer::max2(out_1, vec_[99] +1+t_30);
	...
	uint64_t out_13 = MAP_Explorer::max2(vec_[0] +4+t_45, vec_[1] +7);
	out_13 = MAP_Explorer::max2(out_13, vec_[5] +3+d_[4]);
	out_13 = MAP_Explorer::max2(out_13, vec_[6] +3+t_32);
	out_13 = MAP_Explorer::max2(out_13, vec_[7] +3+t_46);
	out_13 = MAP_Explorer::max2(out_13, vec_[8] +3+t_47);
	out_13 = MAP_Explorer::max2(out_13, vec_[9] +3+t_45);
	out_13 = MAP_Explorer::max2(out_13, vec_[10] +3+t_45);
	out_13 = MAP_Explorer::max2(out_13, vec_[11] +2+t_45);
	out_13 = MAP_Explorer::max2(out_13, vec_[12] +2+t_48);
	...
	out_13 = MAP_Explorer::max2(out_13, vec_[98] +3+t_45);
	out_13 = MAP_Explorer::max2(out_13, vec_[99] +2+t_45);
	uint64_t out_17 = MAP_Explorer::max2(vec_[0] +6+t_10, vec_[1] +6);
	out_17 = MAP_Explorer::max2(out_17, vec_[7] +5+d_[2]);
	out_17 = MAP_Explorer::max2(out_17, vec_[8] +5+t_9);
	out_17 = MAP_Explorer::max2(out_17, vec_[9] +5+t_10);
	out_17 = MAP_Explorer::max2(out_17, vec_[10] +5+t_10);
	out_17 = MAP_Explorer::max2(out_17, vec_[11] +4+t_10);
	...
	out_17 = MAP_Explorer::max2(out_17, vec_[98] +5+t_10);
	out_17 = MAP_Explorer::max2(out_17, vec_[99] +4+t_10);
	...
	uint64_t out_81 = MAP_Explorer::max2(vec_[0] +7+t_23, vec_[1] +9);
	out_81 = MAP_Explorer::max2(out_81, vec_[6] +6+d_[3]);
	out_81 = MAP_Explorer::max2(out_81, vec_[7] +6+t_24);
	out_81 = MAP_Explorer::max2(out_81, vec_[8] +6+t_25);
	out_81 = MAP_Explorer::max2(out_81, vec_[9] +6+t_23);
	out_81 = MAP_Explorer::max2(out_81, vec_[10] +6+t_23);
	out_81 = MAP_Explorer::max2(out_81, vec_[11] +5+t_23);
	out_81 = MAP_Explorer::max2(out_81, vec_[12] +5+t_26);
	...
	out_81 = MAP_Explorer::max2(out_81, vec_[98] +6+t_23);
	out_81 = MAP_Explorer::max2(out_81, vec_[99] +5+t_23);

...
static void block_378_fn(uint64_t* vec_, uint8_t* d_){
	...
	uint64_t out_32 = MAP_Explorer::max2(vec_[0] +7+t_20, vec_[1] +7);
	out_32 = MAP_Explorer::max2(out_32, vec_[6] +6+d_[3]);
	out_32 = MAP_Explorer::max2(out_32, vec_[7] +6+t_15);
	...
	out_32 = MAP_Explorer::max2(out_32, vec_[57] +4);
	...
	out_48 = MAP_Explorer::max2(out_48, vec_[55] +1);

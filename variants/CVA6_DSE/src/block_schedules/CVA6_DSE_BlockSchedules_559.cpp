...
static void block_791_fn(uint64_t* vec_, uint8_t* d_){
	...
	uint64_t out_57 = MAP_Explorer::max2(out_2 +3, vec_[20] +1);
	out_57 = MAP_Explorer::max2(out_57, vec_[21] +2);
	out_57 = MAP_Explorer::max2(out_57, vec_[90] +2);
	uint64_t out_58 = MAP_Explorer::max2(out_3 +3, vec_[21] +1);
	out_58 = MAP_Explorer::max2(out_58, vec_[22] +2);
	...
	out_58 = MAP_Explorer::max2(out_58, vec_[49] +2);
...
extern const MAP_Explorer::Block block_791{
    791,
    2147566972,
    2147566984,
    block_791_fn

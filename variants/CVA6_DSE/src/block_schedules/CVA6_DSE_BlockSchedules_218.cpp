...
static void block_272_fn(uint64_t* vec_, uint8_t* d_){
	...
	out_2 = MAP_Explorer::max2(out_2, vec_[45] +3);
	...
	uint64_t out_46 = MAP_Explorer::max2(vec_[0] +6+t_20, vec_[1] +7);
	out_46 = MAP_Explorer::max2(out_46, vec_[6] +5+d_[3]);
	out_46 = MAP_Explorer::max2(out_46, vec_[7] +5+t_15);
	out_46 = MAP_Explorer::max2(out_46, vec_[8] +5+t_21);
	out_46 = MAP_Explorer::max2(out_46, vec_[9] +5+t_20);
	out_46 = MAP_Explorer::max2(out_46, vec_[10] +5+t_20);
	out_46 = MAP_Explorer::max2(out_46, vec_[11] +4+t_20);
	out_46 = MAP_Explorer::max2(out_46, vec_[12] +4+t_21);
	...
	out_46 = MAP_Explorer::max2(out_46, vec_[45] +5);
	out_46 = MAP_Explorer::max2(out_46, vec_[74] +5);
	out_46 = MAP_Explorer::max2(out_46, vec_[98] +5+t_20);
	out_46 = MAP_Explorer::max2(out_46, vec_[99] +4+t_20);
	...
	out_19 = MAP_Explorer::max2(out_19, vec_[74] +2);
	...
	uint64_t out_77 = MAP_Explorer::max2(out_2 +4, vec_[18] +2);
